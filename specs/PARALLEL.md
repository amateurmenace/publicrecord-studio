...
- 2026-09-24, 21:00Z — **v2.2.7 / r54 is LIVE: every reel row pictures its meeting**
  ...
  files, nothing from a third party. Reviewed through one pass (five,
  folded, re-measured). r54 / 2.2.7 are
  spent; next numbers r55 / 2.2.8.
...
- 2026-09-24, 18:53Z — **v2.2.5 / r52 is LIVE: no one named beside an issue whom
  ...
  `web/bake.py::names_plane`, that both surfaces read). Reviewed through one adversarial pass and a skeptic (six and six, folded).
...
- 2026-09-24 05:28Z — **v2.2.0 / r47 is LIVE: the civic broadsheet**
  ...
  tapes with four counted chapters, four columns, the lens river, the front
